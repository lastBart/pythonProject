...
называй переменные логично
а б с некорректное название
# 3
...
нужно вывести на экран их разность
...
# else:
#     print("Надо работать!")
называй нормально переменные
ты потом не один над проектом работать будешь
людям сложно понять будет что ты имеешь в виду под этими а б с

hours = int(input("Введите отработанные часы: "))
credit = int(input("Введите остаток по кредиту: "))
food = int(input("Введите остаток по кредиту: "))
